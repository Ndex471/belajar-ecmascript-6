...
tersebut dideklarasi.Hal ini
menjadikan JavaScript lebih ketat dalam pendeklarasian variabel, sehingga
dapat meminimalisir peluang terjadinya bug.*/function getMouse(){
    mouse="molucca";
    console.log(mouse);
    let mouse;
}
