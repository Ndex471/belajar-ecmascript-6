...
function makeCoffee(isHot) {
    if (isHot) {
        var coffee = "Make an Hot Coffee"//bila mendeklarasikan variabel dengan var, di belakang layar, JS mengangkat proses deklarasi variabel coffee pada tingkatan atas fungsi
    } else {
